...
export const translations = {
  en: {
    ...
    services: [
      ...
      { name: 'Die Making Materials & Consumables', desc: 'Pertinax boards, ejection rubber, punches, blades and the consumables your line depends on.', cta: 'View Service' },
    ],
  ...
  zh: {
    ...
    services: [
      ...
      { name: '制模材料及耗材', desc: '树脂底板、弹力胶条、冲头、刀片等生产线依赖的核心材料与耗材。', cta: '查看详情' },
    ],
